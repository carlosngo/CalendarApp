...
public class EventIO {
    ...
    public void exportCSV(File csv, TreeMap<Calendar, TreeSet<Model.Event>> events){
        try{
    ...
    public void exportPSV(File psv, TreeMap<Calendar, TreeSet<Model.Event>> events ) {
        try {
    ...
    public ArrayList<Model.Event> importCSV(File csv) {
    ...
    public ArrayList<Model.Event> importPSV(File psv) {
        ArrayList<Model.Event> events = new ArrayList<>();
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                Model.Event e = new Event(c, name, color);
                events.add(e);
            }
        } catch (IOException e) {
            e.printStackTrace();
